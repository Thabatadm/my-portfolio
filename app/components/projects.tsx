        ...
        <div className="max-w-4xl mx-auto mt-24 text-center">
          <div className="bg-zinc-50/50 rounded-2xl p-8 md:p-12 border border-zinc-100">
            ...
            <div className="text-zinc-700 text-sm md:text-base leading-relaxed max-w-3xl mx-auto mb-8 text-justify md:text-center space-y-4 font-sans">
              <p>
                Beyond this featured application, my trajectory includes
                multiple hands-on projects developed both individually and in
                teams at the{" "}
                <strong className="font-semibold text-zinc-950">
                  Universitat Oberta de Catalunya (UOC)
                </strong>
                . From algorithmic scripting and structures engineered in{" "}
                <strong className="font-semibold text-zinc-950">
                  C and Python
                </strong>
                , to foundational layouts built with pure{" "}
                <strong className="font-semibold text-zinc-950">
                  HTML5, CSS3, and Bootstrap
                </strong>
                . My experience expands into robust software architected under{" "}
                <strong className="font-semibold text-zinc-950">
                  OOP and MVC paradigms
                </strong>{" "}
                using modern web stacks like{" "}
                <strong className="font-semibold text-zinc-950">
              ...
              <p>
                ...
                coverage. In these academic workflows, we operated just like
                real agile dev teams: orchestrating GitHub Organizations,
                structuring git branching workflows, and managing multiple
                independent production repositories.
              </p>
            </div>
